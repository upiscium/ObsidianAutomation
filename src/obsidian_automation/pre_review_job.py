...
def _evaluator_recipe_identity(
    ...
    if prompt_version in {
    ...
    elif prompt_version == EVALUATOR_PROMPT_TEMPLATE_V5_VERSION:
        if provider == OPENAI_PROVIDER_NAME:
            return (
        ...
        if provider == OLLAMA_PROVIDER_NAME:
            return (
                V5_OLLAMA_EVALUATOR_ADAPTER_VERSION,
                PREVIOUS_OLLAMA_EVALUATION_STRATEGY,
            )
    elif prompt_version == EVALUATOR_PROMPT_TEMPLATE_V6_VERSION:
        if provider == OPENAI_PROVIDER_NAME:
            return (
        ...
        if provider == OLLAMA_PROVIDER_NAME:
            return (
                PREVIOUS_OLLAMA_EVALUATOR_ADAPTER_VERSION,
                PREVIOUS_OLLAMA_EVALUATION_STRATEGY,
            )
